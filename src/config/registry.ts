export const registryConfig = {
   ...
   * @example "https://mohitpatel.com/r/{name}.json" resolves to "https://mohitpatel.com/r/wheel-picker.json"
   ...
   */
  namespaceUrl:
    process.env.REGISTRY_NAMESPACE_URL || "https://mohitpatel.com/r/{name}.json",
};
