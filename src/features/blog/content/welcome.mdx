...
image: https://assets.mohitpatel.com/images/blog/welcome.webp
...
The source code is available on [GitHub](https://github.com/imohitpatel/mohit.com). You're free to use my code! Just make sure to remove all my personal information before publishing your website. It's awesome to see my code being useful to someone!
