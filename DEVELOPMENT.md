...
```bash
git clone https://github.com/imohitpatel/mohit.com.git minimal-dev-portfolio
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [mohitpatel.com/components](https://mohitpatel.com/components) for installation instructions and component documentation.
